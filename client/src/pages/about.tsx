...
// =============================================================================
// Tells the TotalRefresh story and explains the extraction cleaning philosophy.
// Sections:
//   1. Intro headline and tagline
//   2. Full-width banner image with overlay text
//   3. Body copy explaining the extraction process
//   4. "Our Promise" checklist
//   5. CTA button to the booking page
// =============================================================================
  ...
  return (
    <div className="pb-20">
      <div className="container mx-auto px-4 py-20">
        ...
        {/* Body copy — explains what extraction cleaning is and why it matters */}
